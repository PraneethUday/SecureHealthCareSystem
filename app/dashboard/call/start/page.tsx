  ...
  useEffect(() => {
    const attachStream = async () => {
      if (localVideoRef.current && localStream) {
        ...
        console.log('[CallStart] Stream active:', localStream.active);
        console.log('[CallStart] Video tracks:', localStream.getVideoTracks().length);
        console.log('[CallStart] Audio tracks:', localStream.getAudioTracks().length);
        ...
        try {
          ...
          console.log('[CallStart] ✅ Local video playing');
        } catch (playError) {
          console.error('[CallStart] ❌ Error playing local video:', playError);
        }
        
        console.log('[CallStart] ✅ Local stream attached');
      } else {
