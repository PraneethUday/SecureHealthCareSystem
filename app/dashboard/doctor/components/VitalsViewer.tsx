    ...
    if (!latestVital) {
        return (
            <div className="text-center py-12">
                ...
                <p className="text-gray-500 dark:text-gray-400">No vitals recorded yet</p>
            </div>
        );
    }
            ...
            <div className="flex items-center gap-3 pb-4 border-b border-gray-200 dark:border-gray-700">
                ...
                <div>
                    <h3 className="text-lg font-bold text-gray-900 dark:text-white">
                        {patientName || "Patient"} - Health Vitals
                    </h3>
            ...
            {alerts.length > 0 && (
                <div className="space-y-2">
                    ...
                    {alerts.map((alert) => (
                        <div
                            key={alert.id}
                            className={`p-4 rounded-xl border flex items-start justify-between ${alert.severity === "critical"
                        ...
                        >
                            <div className="flex-1">
                                <div className="flex items-center gap-2 mb-1">
                                    ...
                                    <span
                                        className={`text-xs px-2 py-0.5 rounded-full font-semibold ${alert.severity === "critical"
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
                ...
                {latestVital.blood_pressure_systolic && latestVital.blood_pressure_diastolic && (
                    <VitalCard
                        ...
                        color="rose"
                        alert={
                            latestVital.blood_pressure_systolic >= 140 || latestVital.blood_pressure_diastolic >= 90
                        }
                    />
                )}
                ...
                {latestVital.blood_sugar && (
                    <VitalCard
                        ...
                        color="amber"
                        alert={
                            latestVital.blood_sugar_type === "fasting" && latestVital.blood_sugar >= 126
                        }
                    />
                )}
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    {latestVital.notes && (
                        <div className="p-4 bg-blue-50 dark:bg-blue-900/20 rounded-xl border border-blue-200 dark:border-blue-800">
                            <h4 className="text-sm font-bold text-blue-900 dark:text-blue-200 mb-2">Notes</h4>
...
function VitalCard({
    ...
    return (
        <div
            className={`p-4 rounded-xl border transition-all ${alert
