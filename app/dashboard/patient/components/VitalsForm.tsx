...
export default function VitalsForm({ patientId, onClose, onSuccess }: VitalsFormProps) {
    const [loading, setLoading] = useState(false);
    const [error, setError] = useState<string | null>(null);
    const [success, setSuccess] = useState(false);
    const [activeSection, setActiveSection] = useState<"basic" | "cardio" | "metabolic" | "lifestyle">("basic");
    ...
    if (success) {
        return (
            <div className="flex flex-col items-center justify-center py-12 text-center animate-in fade-in zoom-in duration-300">
                ...
                <h2 className="text-2xl font-bold text-gray-900 dark:text-white mb-2">Vitals Saved!</h2>
        ...
        <div className="w-full">
            ...
            <div className="flex items-center justify-between mb-6">
                <div className="flex items-center gap-3">
                    ...
                    <div>
                        <h2 className="text-2xl font-bold text-gray-900 dark:text-white">Update Vitals</h2>
                        <p className="text-sm text-gray-500 dark:text-gray-400">Track your health metrics</p>
                    </div>
                </div>
                <button
                    onClick={onClose}
                ...
                {[
                    ...
                    return (
                        <button
                            ...
                            className={`flex items-center gap-2 px-4 py-2 rounded-lg text-sm font-semibold transition-all whitespace-nowrap ${activeSection === section.id
                        ...
                        {bmi && (
                            <div className="p-4 bg-gradient-to-r from-blue-50 to-purple-50 dark:from-blue-900/20 dark:to-purple-900/20 rounded-xl border border-blue-200 dark:border-blue-800">
                                <div className="flex items-center gap-2 mb-1">
                                    ...
                                    <span className="text-sm font-semibold text-gray-700 dark:text-gray-300">BMI (Auto-calculated)</span>
                                </div>
                                <p className="text-2xl font-bold text-blue-600 dark:text-blue-400">{bmi}</p>
                    ...
                    <div className="space-y-4 animate-in fade-in slide-in-from-bottom-4 duration-300">
                        ...
                        <div className="space-y-2">
                            ...
                            <div className="flex justify-between text-xs text-gray-500 dark:text-gray-400">
                                <span>Low (1)</span>
                                <span className="font-bold text-purple-600 dark:text-purple-400">{formData.stress_level}</span>
                                <span>High (10)</span>
                            </div>
                        </div>

                        <div className="space-y-2">
                            <label className="text-sm font-semibold text-gray-700 dark:text-gray-300">Symptoms</label>
                            <textarea
                                name="symptoms"
