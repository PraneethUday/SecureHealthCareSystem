...
async function applySecurityFixes() {
    console.log("🛠️ Applying Security Parity Fixes for Doctors...\n");
    ...
    // We'll reset password_changed_at to NULL for any doc who:
    // - has plaintext password but no hash
    // - has no password_changed_at record
